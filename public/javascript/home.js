...
const socket = io("http://13.127.249.154:80");
...
async function fetchUsers(username) {
  try {
    const response = await fetch("http://13.127.249.154:80/user",{
      method: "POST",
      headers: {
...
async function openMessageBox(_id, username, i, is_groupchat, groupName,groupAdmin) {
  ...
  const response = await fetch("http://13.127.249.154:80/getid",{
    method:"GET"
  })
...
const fetchMessages = async (_id) => {
  try {
    const response = await fetch(`http://13.127.249.154:80/message/${_id}`, {
      method: "get",
    });
    const data = await response.json();
...
async function createChat(_id) {
  try {
    const response = await fetch("http://13.127.249.154:80/chat/chats", {
      method: "post",
      headers: {
        "Content-Type": "application/json",
      },
...
const sendingMessage = async (e) => {
  if (e.key == "Enter" && e.target.value) {
    ...
    try {
      const response = await fetch("http://13.127.249.154:80/message", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
const createGroup = async (e) => {
  try {
    ...
    const response = await fetch("http://13.127.249.154:80/chat/groupchat", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const deleteGroupchat = async()=>{
  ...
  try {
    ...
    const response  = await fetch("http://13.127.249.154:80/chat/deletegroupchat", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const leaveGroupchat = async()=>{
  try {
    ...
    const response  = await fetch("http://13.127.249.154:80/chat/leavegroupchat", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
