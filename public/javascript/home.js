...
async function openMessageBox(_id, username, i, is_groupchat, groupName,groupAdmin) {
  ...
  const response = await fetch("http://localhost:2000/getid",{
    method:"GET"
  })
...
const fetchMessages = async (_id) => {
  try {
    const response = await fetch(`http://localhost:2000/message/${_id}`, {
      method: "get",
    });
    const data = await response.json();
...
async function createChat(_id) {
  try {
    const response = await fetch("http://localhost:2000/chat/chats", {
      method: "post",
      headers: {
        "Content-Type": "application/json",
      },
...
const createGroup = async (e) => {
  try {
    ...
    const response = await fetch("http://localhost:2000/chat/groupchat", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const deleteGroupchat = async()=>{
  ...
  try {
    ...
    const response  = await fetch("http://localhost:2000/chat/deletegroupchat", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const leaveGroupchat = async()=>{
  try {
    ...
    const response  = await fetch("http://localhost:2000/chat/leavegroupchat", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
